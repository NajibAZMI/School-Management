...
<head>
   ...
   <!-- <link rel="stylesheet" href="../../style/login/Global.css">-->
    <link rel="stylesheet" href="../../style/coordinateur/EtudinaTAbsence.css">
...
<nav class="navbarline">       
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><th>Nom de la Classe</th><th>Téléchargement</th></tr>";
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>";
            echo "<td>" . $row["nom_classe"] . "</td>";
            echo "<td><form action='emploi_toutes_class.php' method='post'>";
