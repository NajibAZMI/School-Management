...
// SQL query to get the class timetable
$sql_emploi = "SELECT * FROM emploi_class WHERE id_class = '$id_classe' ORDER BY id_emploi_classe DESC LIMIT 1";
...
// SQL query to get the class name
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        global $nom_classe;  // Use global to access the class name
        $image = '../../image/t1.png'; 
        $header_height = 20; 
        ...
        $this->Cell(0, 10, 'Emploi du temps - ' . $nom_classe, 0, 1, 'C'); // Center the title
        $this->Ln(5);
    }
