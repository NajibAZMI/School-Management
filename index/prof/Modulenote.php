...
if (isset($_POST["Consulter_Note"])) {
    if (isset($_POST["id_module"])) {
        $_SESSION["id_module"] = $_POST["id_module"];
    }
    header("Location: consulter_notes.php");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="../../style/login/MoDulENOtE.css">
   <!-- <link rel="stylesheet" href="../../style/prof/MoDulenote.css">  -->
